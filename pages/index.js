          ...
          <div className="row align-items-end pb-35">
            <div className="col-lg-8">
              <div className="section-title mb-25 wow fadeInLeft delay-0-2s">
                <span className="sub-title mb-10">Our Tactics and  &amp; Tricks</span>
                <h2>Easy Ways to Boost Your Sales!</h2>
              </div>
            </div>
          ...
          <div className="row justify-content-center">
            <div className="col-xl-4 col-md-6">
              <div className="blog-item wow fadeInUp delay-0-2s">
                <div className="image">
                  <img src="assets/images/banner/ecom.jpg" alt="Blog" />
                </div>
                <div className="content">
                  ...
                  <h4>
                    <Link legacyBehavior href="">
                      {`Online Shop Mastery: Boosting Your E-Commerce Success`}
                    </Link>
                  </h4>
                  <div className="author-more">
                    <span className="author">
                      By <a href="#">Prosper Gwizi</a>
                    </span>
                    <Link legacyBehavior href="">
            ...
            <div className="col-xl-4 col-md-6">
              <div className="blog-item wow fadeInUp delay-0-4s">
                <div className="image">
                <img src="assets/images/banner/seo-blog.jpg" alt="Blog" />
                </div>
                <div className="content">
                  <ul className="blog-meta">
                    <li>
                      <i className="far fa-calendar-alt" />{" "}
                      <a href="#">October 26, 2023</a>
                    </li>
                    <li>
                      <i className="far fa-calendar-alt" />{" "}
                      <a href="#">Comments (2)</a>
                  ...
                  <h4>
                    <Link legacyBehavior href="">
                 A Comprehensive Guide to Crafting Content that Dominates Search Rankings
                    </Link>
                  </h4>
                  <div className="author-more">
                    <span className="author">
                      By <a href="#">Elson Ncube</a>
                    </span>
                    <Link legacyBehavior href="">
                      <a className="read-more">
                        Read More <i className="far fa-arrow-right" />
            ...
            <div className="col-xl-4 col-md-6">
              <div className="blog-item wow fadeInUp delay-0-6s">
                <div className="image">
                <img src="assets/images/banner/search.jpg" alt="Blog" />
                </div>
                <div className="content">
                  <ul className="blog-meta">
                    <li>
                      <i className="far fa-calendar-alt" />{" "}
                      <a href="#">October 17, 2022</a>
                    </li>
                    <li>
                      <i className="far fa-calendar-alt" />{" "}
                      <a href="#">Comments (1)</a>
                  ...
                  <h4>
                    <Link legacyBehavior href="">
                    Click to Success: Mastering Google Ads for Your Business Growth
                    </Link>
                  </h4>
                  <div className="author-more">
                    <span className="author">
                      By <a href="#">Kito Ndlovu</a>
                    </span>
                    <Link legacyBehavior href="">
                      <a className="read-more">
                        Read More <i className="far fa-arrow-right" />
