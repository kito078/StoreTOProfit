        ...
        <div className="container">
          ...
          >
            <div className="section-title wow fadeInLeft delay-0-2s">
              <span className="sub-title text-white">Need Any Consultations ?</span>
              <h2 className="text-white">Boost your business with more sales</h2>
            </div>
            ...
            <div className="footer-widget widget_about wow fadeInUp delay-0-2s">
              <div className="footer-logo mb-30">
                <Link legacyBehavior href="/index">
                  <a>
                    <img src="assets/images/banner/brand2.png" alt="Logo" />
                  </a>
                </Link>
              </div>
              <p>
              Copyright 2023 StoreToProfit
              </p>
            ...
            <div className="row">
              ...
              <div className="col-md-4 col-6 col-small">
                <div className="footer-widget widget_nav_menu wow fadeInUp delay-0-4s">
                  <h4 className="footer-title">TERMS OF SERVICE</h4>
                  <ul className="list-style-two">
                    {/* <li>
          ...
          <div className="row align-items-center">
            ...
            <div className="col-lg-4">
              <div className="copyright-text text-lg-end wow fadeInLeft delay-0-2s">
                <p>© 2023 StoreToProfit. All rights reserved.</p>
              </div>
            </div>
          </div>
        </div>
